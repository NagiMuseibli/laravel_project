...
class staffRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'vezife' => 'required|min:3|max:14',
            'maash' => 'required|min:3|max:6',
            'hired' => 'required|min:10|max:14',
    ...
    public function messages()
    {
        return [
            ...
            'vezife.required' => 'Vəzifə adını daxil etmediniz',
            'maash.min' => 'Əmək haqqı minimum 3 simvol olmalıdır',
            'hired.max' => 'Tarix seçmədiniz',
        ];
    }
}
