...
class ClientsRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'sirket.required'=>'Sirketin adini daxil etmediniz',
            'sirket.min'=>'Sirketin adi minimum 3 simvol olmalidir',
            'sirket.max'=>'Sirketin adi maksimum 14 simvol olmalidir',
