            ...
            <div class="card-body px-5 py-5">
              ...
              <form method="post" action="{{route('register.submit')}}">
                ...
                <div class="form-group">
                  <label>Ad</label>
                  <input type="text" name="ad" class="form-control p_input">
                </div>

                <div class="form-group">
                  <label>Soyad</label>
                  <input type="text" name="soyad" class="form-control p_input">
                </div>
                <div class="form-group">
                  <label>Tel</label>
                ...
                <div class="form-group">
                  ...
                  <input type="password" name="tpassword" class="form-control p_input">
                </div>
